            ...
            if hand_recognition_result.gestures:
                ...
                if gesture_name in ["Pointing_Up"] and confidence > 0.4:
                    ...
                    if (
                        ...
                        if self.current_effect_stage["current"] >= self.frames_before:
                            print("Charging complete, advancing to fireball animation")
            ...
            if (
                ...
                try:
                    ...
                    if (
                        ...
                        self.current_effect_stage["current"] = self.frames_before + 1
                    ...
                    if self.current_effect_stage["stage"] == self.frames_before + 2:
                        ...
                        if (
                            self.current_effect_stage.get("bottom_center") is not None
                            ...
                            if (
                                ...
                                if resized_overlay.shape[2] == 4:
                                    print("Applying RGBA overlay with alpha blending")
                                    ...
                                    img[y_start:y_end, x_start:x_end] = resized_overlay[
                                        :, :, :3
                                    ]
                            else:
                                print("Overlay position out of bounds, skipping")
                        else:
                            if self.current_effect_stage.get("bottom_center") is None:
